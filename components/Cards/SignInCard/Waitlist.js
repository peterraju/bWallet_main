...
<p className='max-w-[50ch] text-white opacity-50 font-prm text-lg'>
...
<button style={{
        ...
        }} className="p-3 rounded-prm flex items-center gap-3 w-fit text-white font-prm mt-4">Sign Up <PiArrowUpRightBold/></button>
    </div>
  )
}
